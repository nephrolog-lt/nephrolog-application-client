...
class _$AutomaticPeritonealDialysisSerializer implements StructuredSerializer<AutomaticPeritonealDialysis> {
    ...
    Iterable<Object?> serialize(Serializers serializers, AutomaticPeritonealDialysis object,
        ...
        result
            ...
            ..add(object.dailyHealthStatus == null ? null : serializers.serialize(object.dailyHealthStatus,
                specifiedType: const FullType.nullable(DailyHealthStatus)));
        result
            ..add(r'daily_intakes_light_report')
            ..add(object.dailyIntakesLightReport == null ? null : serializers.serialize(object.dailyIntakesLightReport,
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'daily_health_status':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(DailyHealthStatus)) as DailyHealthStatus?;
