...
class _$UserProfile extends UserProfile {
  ...
  _$UserProfile._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(gender, 'UserProfile', 'gender');
    BuiltValueNullFieldError.checkNotNull(heightCm, 'UserProfile', 'heightCm');
    BuiltValueNullFieldError.checkNotNull(
        chronicKidneyDiseaseYears, 'UserProfile', 'chronicKidneyDiseaseYears');
    BuiltValueNullFieldError.checkNotNull(
        chronicKidneyDiseaseStage, 'UserProfile', 'chronicKidneyDiseaseStage');
    BuiltValueNullFieldError.checkNotNull(
        dialysisType, 'UserProfile', 'dialysisType');
  }
