...
class NutritionApi {
  ...
  Future<Response<BuiltList<Product>>> nutritionProductsList({ 
    ...
    final _path = r'/v1/nutrition/products/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<NutritionScreenResponse>> nutritionScreenRetrieve({ 
    ...
    final _path = r'/v1/nutrition/screen/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    NutritionScreenResponse _responseData;

    try {
      const _responseType = FullType(NutritionScreenResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as NutritionScreenResponse;
