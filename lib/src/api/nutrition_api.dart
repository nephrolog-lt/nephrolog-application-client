...
class NutritionApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DailyIntakesReportsResponse] as data
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DailyIntakesReportResponse] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Intake] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MissingProduct] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  Future<Response<ProductSearchResponse>> nutritionProductsSearchRetrieve({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (excludeProducts != null) r'exclude_products': encodeQueryParameter(_serializers, excludeProducts, const FullType(String)),
      if (mealType != null) r'meal_type': encodeQueryParameter(_serializers, mealType, const FullType(String)),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NutritionScreenV2Response] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NutrientWeeklyScreenResponse] as data
  /// Throws [DioError] if API call or serialization fails
