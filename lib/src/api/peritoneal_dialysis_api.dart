...
class PeritonealDialysisApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AutomaticPeritonealDialysis] as data
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AutomaticPeritonealDialysisPeriodResponse] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AutomaticPeritonealDialysisScreenResponse] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ManualPeritonealDialysis] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ManualPeritonealDialysisScreenResponse] as data
  /// Throws [DioError] if API call or serialization fails
