...
class _$ProductRequestSerializer
  ...
  Iterable<Object> serialize(Serializers serializers, ProductRequest object,
    ...
    final result = <Object>[
      ...
      'product_kind',
      serializers.serialize(object.productKind,
...
class _$ProductRequest extends ProductRequest {
  ...
  _$ProductRequest._(
      ...
      : super._() {
    if (name == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'name');
    }
    if (productKind == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'productKind');
    }
    if (potassiumMg == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'potassiumMg');
    }
    if (proteinsMg == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'proteinsMg');
    }
    if (sodiumMg == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'sodiumMg');
    }
    if (phosphorusMg == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'phosphorusMg');
    }
    if (energyKcal == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'energyKcal');
    }
    if (liquidsMl == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'liquidsMl');
    }
    if (carbohydratesMg == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'carbohydratesMg');
    }
    if (fatMg == null) {
      throw new BuiltValueNullFieldError('ProductRequest', 'fatMg');
    }
  }
