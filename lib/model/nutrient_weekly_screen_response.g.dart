...
class _$NutrientWeeklyScreenResponse extends NutrientWeeklyScreenResponse {
  @override
  final OffsetDate earliestReportDate;
  @override
...
class NutrientWeeklyScreenResponseBuilder
  ...
  OffsetDate _earliestReportDate;
  OffsetDate get earliestReportDate => _$this._earliestReportDate;
  set earliestReportDate(OffsetDate earliestReportDate) =>
