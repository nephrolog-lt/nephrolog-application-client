...
class _$AutomaticPeritonealDialysisSerializer
  ...
  Iterable<Object> serialize(
    ...
    if (object.dailyHealthStatus != null) {
      result
        ..add('daily_health_status')
        ..add(serializers.serialize(object.dailyHealthStatus,
            specifiedType: const FullType(DailyHealthStatus)));
    }
    if (object.dailyIntakesLightReport != null) {
      result
        ..add('daily_intakes_light_report')
    ...
    try {
      _$result = _$v ??
          new _$AutomaticPeritonealDialysis._(
              date: date,
              dailyHealthStatus: _dailyHealthStatus?.build(),
              dailyIntakesLightReport: _dailyIntakesLightReport?.build(),
      ...
      try {
        ...
        _dailyHealthStatus?.build();
        _$failedField = 'dailyIntakesLightReport';
        _dailyIntakesLightReport?.build();
      } catch (e) {
