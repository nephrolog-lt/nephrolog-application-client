...
class _$DailyIntakesReportsResponseSerializer
  ...
  Iterable<Object> serialize(
    ...
    final result = <Object>[];
    if (object.dailyIntakesLightReports != null) {
      result
        ..add('daily_intakes_light_reports')
    ...
    try {
      _$result = _$v ??
          new _$DailyIntakesReportsResponse._(
              dailyIntakesLightReports: _dailyIntakesLightReports?.build());
    } catch (_) {
      String _$failedField;
      try {
        _$failedField = 'dailyIntakesLightReports';
        _dailyIntakesLightReports?.build();
      } catch (e) {
