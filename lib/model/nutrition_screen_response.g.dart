...
class _$NutritionScreenResponseSerializer
  ...
  Iterable<Object> serialize(
    ...
    final result = <Object>[
      'today_intakes_report',
      serializers.serialize(object.todayIntakesReport,
      ...
      'latest_intakes',
      serializers.serialize(object.latestIntakes,
          specifiedType:
              const FullType(BuiltList, const [const FullType(Intake)])),
      'current_month_daily_reports',
      serializers.serialize(object.currentMonthDailyReports,
          specifiedType: const FullType(
              BuiltList, const [const FullType(DailyIntakesLightReport)])),
      'nutrition_summary_statistics',
      serializers.serialize(object.nutritionSummaryStatistics,
...
class _$NutritionScreenResponse extends NutritionScreenResponse {
  ...
  _$NutritionScreenResponse._(
      ...
      : super._() {
    if (todayIntakesReport == null) {
      throw new BuiltValueNullFieldError(
          'NutritionScreenResponse', 'todayIntakesReport');
    }
    if (dailyIntakesReports == null) {
      throw new BuiltValueNullFieldError(
          'NutritionScreenResponse', 'dailyIntakesReports');
    }
    if (latestIntakes == null) {
      throw new BuiltValueNullFieldError(
          'NutritionScreenResponse', 'latestIntakes');
    }
    if (currentMonthDailyReports == null) {
      throw new BuiltValueNullFieldError(
          'NutritionScreenResponse', 'currentMonthDailyReports');
    }
    if (nutritionSummaryStatistics == null) {
      throw new BuiltValueNullFieldError(
