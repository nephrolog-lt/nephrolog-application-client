...
class _$IntakeRequest extends IntakeRequest {
  ...
  _$IntakeRequest._({this.productId, this.consumedAt, this.amountG})
      : super._();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, productId.hashCode), consumedAt.hashCode),
        amountG.hashCode));
  }
  ...
  _$IntakeRequest build() {
    final _$result = _$v ??
        new _$IntakeRequest._(
            productId: productId, consumedAt: consumedAt, amountG: amountG);
    replace(_$result);
    return _$result;
  }
}
