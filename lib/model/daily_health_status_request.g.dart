    ...
    final result = <Object>[
      ...
      serializers.serialize(object.swellings,
          specifiedType: const FullType(
              BuiltList, const [const FullType(SwellingRequest)])),
    ];
...
class _$DailyHealthStatusRequest extends DailyHealthStatusRequest {
  ...
  _$DailyHealthStatusRequest._(
      ...
      : super._() {
    if (date == null) {
      throw new BuiltValueNullFieldError('DailyHealthStatusRequest', 'date');
    }
    if (swellingDifficulty == null) {
      throw new BuiltValueNullFieldError(
          'DailyHealthStatusRequest', 'swellingDifficulty');
    }
    if (wellFeeling == null) {
      throw new BuiltValueNullFieldError(
          'DailyHealthStatusRequest', 'wellFeeling');
    }
    if (appetite == null) {
      throw new BuiltValueNullFieldError(
          'DailyHealthStatusRequest', 'appetite');
    }
    if (shortnessOfBreath == null) {
      throw new BuiltValueNullFieldError(
          'DailyHealthStatusRequest', 'shortnessOfBreath');
    }
    if (swellings == null) {
      throw new BuiltValueNullFieldError(
          'DailyHealthStatusRequest', 'swellings');
    }
  }
