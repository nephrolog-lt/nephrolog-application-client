...
class _$Product extends Product {
  ...
  _$Product._({this.id, this.name, this.productKind}) : super._();
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, id.hashCode), name.hashCode), productKind.hashCode));
  }
...
class ProductBuilder implements Builder<Product, ProductBuilder> {
  ...
  _$Product build() {
    final _$result =
        _$v ?? new _$Product._(id: id, name: name, productKind: productKind);
    replace(_$result);
    return _$result;
  }
}
