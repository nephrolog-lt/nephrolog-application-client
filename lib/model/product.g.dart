...
class _$Product extends Product {
  ...
  _$Product._(
    ...
    if (productKind == null) {
      throw new BuiltValueNullFieldError('Product', 'productKind');
    }
    if (potassiumMg == null) {
      throw new BuiltValueNullFieldError('Product', 'potassiumMg');
    }
    if (proteinsMg == null) {
      throw new BuiltValueNullFieldError('Product', 'proteinsMg');
    }
    if (sodiumMg == null) {
      throw new BuiltValueNullFieldError('Product', 'sodiumMg');
    }
    if (phosphorusMg == null) {
      throw new BuiltValueNullFieldError('Product', 'phosphorusMg');
    }
    if (energyKcal == null) {
      throw new BuiltValueNullFieldError('Product', 'energyKcal');
    }
    if (liquidsMl == null) {
      throw new BuiltValueNullFieldError('Product', 'liquidsMl');
    }
    if (carbohydratesMg == null) {
      throw new BuiltValueNullFieldError('Product', 'carbohydratesMg');
    }
    if (fatMg == null) {
      throw new BuiltValueNullFieldError('Product', 'fatMg');
    }
  }
