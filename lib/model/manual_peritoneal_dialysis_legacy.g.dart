...
part of 'manual_peritoneal_dialysis_legacy.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ManualPeritonealDialysisLegacy>
    _$manualPeritonealDialysisLegacySerializer =
    new _$ManualPeritonealDialysisLegacySerializer();

class _$ManualPeritonealDialysisLegacySerializer
    implements StructuredSerializer<ManualPeritonealDialysisLegacy> {
  @override
  final Iterable<Type> types = const [
    ManualPeritonealDialysisLegacy,
    _$ManualPeritonealDialysisLegacy
  ];
  @override
  final String wireName = 'ManualPeritonealDialysisLegacy';

  @override
  Iterable<Object> serialize(
      Serializers serializers, ManualPeritonealDialysisLegacy object,
  ...
  @override
  ManualPeritonealDialysisLegacy deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ManualPeritonealDialysisLegacyBuilder();
...
class _$ManualPeritonealDialysisLegacy extends ManualPeritonealDialysisLegacy {
  @override
  final int id;
  @override
  ...
  factory _$ManualPeritonealDialysisLegacy(
          [void Function(ManualPeritonealDialysisLegacyBuilder) updates]) =>
      (new ManualPeritonealDialysisLegacyBuilder()..update(updates)).build();

  _$ManualPeritonealDialysisLegacy._(
      {this.id,
      this.isCompleted,
      this.startedAt,
      this.bloodPressure,
  ...
  @override
  ManualPeritonealDialysisLegacy rebuild(
          void Function(ManualPeritonealDialysisLegacyBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ManualPeritonealDialysisLegacyBuilder toBuilder() =>
      new ManualPeritonealDialysisLegacyBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ManualPeritonealDialysisLegacy &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ManualPeritonealDialysisLegacy')
          ..add('id', id)
...
class ManualPeritonealDialysisLegacyBuilder
    implements
        Builder<ManualPeritonealDialysisLegacy,
            ManualPeritonealDialysisLegacyBuilder> {
  _$ManualPeritonealDialysisLegacy _$v;
  ...
  ManualPeritonealDialysisLegacyBuilder() {
    ManualPeritonealDialysisLegacy._initializeBuilder(this);
  }

  ManualPeritonealDialysisLegacyBuilder get _$this {
    if (_$v != null) {
      _id = _$v.id;
  ...
  @override
  void replace(ManualPeritonealDialysisLegacy other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ManualPeritonealDialysisLegacy;
  }

  @override
  void update(void Function(ManualPeritonealDialysisLegacyBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$ManualPeritonealDialysisLegacy build() {
    _$ManualPeritonealDialysisLegacy _$result;
    try {
      _$result = _$v ??
          new _$ManualPeritonealDialysisLegacy._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'ManualPeritonealDialysisLegacy', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
