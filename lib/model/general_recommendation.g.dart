...
class _$GeneralRecommendation extends GeneralRecommendation {
  ...
  _$GeneralRecommendation._({this.id, this.question, this.answer, this.order})
      : super._() {
    if (id == null) {
      throw new BuiltValueNullFieldError('GeneralRecommendation', 'id');
    }
    if (question == null) {
      throw new BuiltValueNullFieldError('GeneralRecommendation', 'question');
    }
    if (answer == null) {
      throw new BuiltValueNullFieldError('GeneralRecommendation', 'answer');
    }
    if (order == null) {
      throw new BuiltValueNullFieldError('GeneralRecommendation', 'order');
    }
  }
