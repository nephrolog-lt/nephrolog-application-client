...
class _$NutritionScreenV2ResponseSerializer
  ...
  Iterable<Object> serialize(
    ...
    final result = <Object>[
      'today_light_nutrition_report',
      serializers.serialize(object.todayLightNutritionReport,
      ...
      'current_month_nutrition_reports',
      serializers.serialize(object.currentMonthNutritionReports,
          specifiedType: const FullType(
              BuiltList, const [const FullType(DailyIntakesLightReport)])),
      'latest_intakes',
...
class _$NutritionScreenV2Response extends NutritionScreenV2Response {
  ...
  _$NutritionScreenV2Response._(
      ...
      : super._() {
    if (todayLightNutritionReport == null) {
    ...
    if (currentMonthNutritionReports == null) {
      throw new BuiltValueNullFieldError(
          'NutritionScreenV2Response', 'currentMonthNutritionReports');
    }
    if (latestIntakes == null) {
      throw new BuiltValueNullFieldError(
          'NutritionScreenV2Response', 'latestIntakes');
    }
