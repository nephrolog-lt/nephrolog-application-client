...
class _$BloodPressureSerializer implements StructuredSerializer<BloodPressure> {
  ...
  Iterable<Object> serialize(Serializers serializers, BloodPressure object,
    ...
    final result = <Object>[
      ...
      serializers.serialize(object.systolicBloodPressure,
          specifiedType: const FullType(int)),
      'diastolic_blood_pressure',
      serializers.serialize(object.diastolicBloodPressure,
          specifiedType: const FullType(int)),
      'measured_at',
...
class _$BloodPressure extends BloodPressure {
  ...
  _$BloodPressure._(
      ...
      : super._() {
    if (id == null) {
      throw new BuiltValueNullFieldError('BloodPressure', 'id');
    }
    ...
    if (measuredAt == null) {
      throw new BuiltValueNullFieldError('BloodPressure', 'measuredAt');
    }
  }
