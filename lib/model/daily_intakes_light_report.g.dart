...
class _$DailyIntakesLightReportSerializer
  ...
  Iterable<Object> serialize(
    ...
    final result = <Object>[
      ...
      'nutrient_norms_and_totals',
      serializers.serialize(object.nutrientNormsAndTotals,
...
class _$DailyIntakesLightReport extends DailyIntakesLightReport {
  ...
  _$DailyIntakesLightReport._({this.date, this.nutrientNormsAndTotals})
      : super._() {
    if (date == null) {
      throw new BuiltValueNullFieldError('DailyIntakesLightReport', 'date');
    }
    if (nutrientNormsAndTotals == null) {
