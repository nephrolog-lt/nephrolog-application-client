...
class UserApi {
    ...
    Future<Response<UserAppReview>> userAppReviewRetrieve({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(UserAppReview);
            final data = _serializers.deserializeWith<UserAppReview>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
