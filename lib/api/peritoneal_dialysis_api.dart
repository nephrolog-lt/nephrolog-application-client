...
class PeritonealDialysisApi {
    ...
    Future<Response<AutomaticPeritonealDialysisPeriodResponse>> peritonealDialysisAutomaticPeriodRetrieve(
        ...
        final String _path = '/v1/peritoneal-dialysis/automatic/period/';
        ...
        return _dio.request<dynamic>(
            ...
            final serializer = _serializers.serializerForType(AutomaticPeritonealDialysisPeriodResponse) as Serializer<AutomaticPeritonealDialysisPeriodResponse>;
            final data = _serializers.deserializeWith<AutomaticPeritonealDialysisPeriodResponse>(
                serializer,
                response.data is String ? jsonDecode(response.data as String) : response.data,
            );
