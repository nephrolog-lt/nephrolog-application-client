...
class NutritionApi {
    ...
    ///
    /// 
    Future<Response<DailyIntakesReportsResponse>> nutritionDailyIntakesReportsLightRetrieve({ 
        ...
        final String _path = '/v1/nutrition/daily-intakes-reports/light/';
    ...
    ///
    /// 
    Future<Response<DailyIntakesReportResponse>> nutritionDailyIntakesReportsRetrieve(
        String date, { 
        CancelToken cancelToken,
        Map<String, dynamic> headers,
        Map<String, dynamic> extra,
        ...
        final String _path = '/v1/nutrition/daily-intakes-reports/{date}/'.replaceAll('{' r'date' '}', date.toString());
