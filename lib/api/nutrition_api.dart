...
class NutritionApi {
    ...
    Future<Response<DailyIntakesReportsResponse>> nutritionDailyReportsLightRetrieve({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(DailyIntakesReportsResponse);
            final data = _serializers.deserializeWith<DailyIntakesReportsResponse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<DailyIntakesReportResponse>> nutritionDailyReportsRetrieve(
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(DailyIntakesReportResponse);
            final data = _serializers.deserializeWith<DailyIntakesReportResponse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<ProductSearchResponse>> nutritionProductsSearchRetrieve({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(ProductSearchResponse);
            final data = _serializers.deserializeWith<ProductSearchResponse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<NutritionScreenResponse>> nutritionScreenRetrieve({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(NutritionScreenResponse);
            final data = _serializers.deserializeWith<NutritionScreenResponse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<NutritionScreenV2Response>> nutritionScreenV2Retrieve({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(NutritionScreenV2Response);
            final data = _serializers.deserializeWith<NutritionScreenV2Response>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
