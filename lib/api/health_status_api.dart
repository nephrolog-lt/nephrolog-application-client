...
class HealthStatusApi {
    ...
    Future<Response<BloodPressure>> healthStatusBloodPressureCreate(
        ...
        final serializedBody = _serializers.serialize(bloodPressureRequest);
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(BloodPressure);
            final data = _serializers.deserializeWith<BloodPressure>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<Pulse>> healthStatusPulseCreate(
        ...
        final serializedBody = _serializers.serialize(pulseRequest);
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(Pulse);
            final data = _serializers.deserializeWith<Pulse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
