...
class HealthStatusApi {
    ...
    HealthStatusApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<DailyHealthStatusesResponse>>v1HealthStatusGet({ DateTime from,DateTime to,CancelToken cancelToken, Map<String, String> headers,}) async {
        ...
        ///
        /// 
        Future<Response<DailyHealthStatus>>v1HealthStatusIdGet(DateTime date,String id,{ CancelToken cancelToken, Map<String, String> headers,}) async {
        ...
        ///
        /// 
        Future<Response<DailyHealthStatus>>v1HealthStatusIdPut(DateTime date,String id,{ DailyHealthStatus dailyHealthStatus,CancelToken cancelToken, Map<String, String> headers,}) async {
