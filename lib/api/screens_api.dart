...
class ScreensApi {
    ...
    ScreensApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<DailyIntakesScreen>>v1ScreensDailyIntakesGet({ OffsetDate from,OffsetDate to,CancelToken cancelToken, Map<String, String> headers,}) async {
        ...
        ///
        /// 
        Future<Response<UserHealthStatusReport>>v1ScreensHealthStatusGet({ OffsetDate from,OffsetDate to,CancelToken cancelToken, Map<String, String> headers,}) async {
