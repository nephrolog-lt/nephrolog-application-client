library nephrogo_api_client.api;

import 'package:dio/dio.dart';
import 'package:built_value/serializer.dart';
import 'package:nephrogo_api_client/serializers.dart';
import 'package:nephrogo_api_client/auth/api_key_auth.dart';
import 'package:nephrogo_api_client/auth/basic_auth.dart';
import 'package:nephrogo_api_client/auth/oauth.dart';
...
class NephrogoApiClient {
    ...
    NephrogoApiClient({this.dio, Serializers serializers, String basePathOverride, List<Interceptor> interceptors}) {
        if (dio == null) {
