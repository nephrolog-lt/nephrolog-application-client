...
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(DailyManualPeritonealDialysisReport)]),
() => new ListBuilder<DailyManualPeritonealDialysisReport>())
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(DailyManualPeritonealDialysisReportResponse)]),
() => new ListBuilder<DailyManualPeritonealDialysisReportResponse>())
..addBuilderFactory(
...
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(ManualPeritonealDialysis)]),
() => new ListBuilder<ManualPeritonealDialysis>())
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(ManualPeritonealDialysisRequest)]),
() => new ListBuilder<ManualPeritonealDialysisRequest>())
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(ManualPeritonealDialysisScreenResponse)]),
() => new ListBuilder<ManualPeritonealDialysisScreenResponse>())
..addBuilderFactory(
...
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(PaginatedDailyManualPeritonealDialysisReportList)]),
() => new ListBuilder<PaginatedDailyManualPeritonealDialysisReportList>())
..addBuilderFactory(
