...
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(AutomaticPeritonealDialysis)]),
() => new ListBuilder<AutomaticPeritonealDialysis>())
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(AutomaticPeritonealDialysisRequest)]),
() => new ListBuilder<AutomaticPeritonealDialysisRequest>())
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(AutomaticPeritonealDialysisScreenResponse)]),
() => new ListBuilder<AutomaticPeritonealDialysisScreenResponse>())
..addBuilderFactory(
