...
import 'package:nephrogo_api_client/model/user_nutrition_summary_request.dart';
...
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(UserNutritionSummary)]),
() => new ListBuilder<UserNutritionSummary>())
..addBuilderFactory(
const FullType(BuiltList, const [const FullType(UserNutritionSummaryRequest)]),
() => new ListBuilder<UserNutritionSummaryRequest>())
..addBuilderFactory(
