...
[**healthStatusPartialUpdate**](HealthStatusApi.md#healthStatusPartialUpdate) | **patch** /v1/health-status/{date}/ | 
...
[**healthStatusUpdate**](HealthStatusApi.md#healthStatusUpdate) | **put** /v1/health-status/{date}/ | 
...
> DailyHealthStatus healthStatusPartialUpdate(date, dailyHealthStatusRequest)
...
try { 
    var result = api_instance.healthStatusPartialUpdate(date, dailyHealthStatusRequest);
    print(result);
} catch (e) {
...
# **healthStatusUpdate**
> DailyHealthStatus healthStatusUpdate(date, dailyHealthStatusRequest)
...
try { 
    var result = api_instance.healthStatusUpdate(date, dailyHealthStatusRequest);
    print(result);
} catch (e) {
