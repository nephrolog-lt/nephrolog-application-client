...
var from = 2013-10-20; // Date | 
var to = 2013-10-20; // Date | 
...
var api_instance = new NutritionApi();
var missingProductRequest = new MissingProductRequest(); // MissingProductRequest | 

try { 
    var result = api_instance.nutritionProductsMissingCreate(missingProductRequest);
    print(result);
} catch (e) {
