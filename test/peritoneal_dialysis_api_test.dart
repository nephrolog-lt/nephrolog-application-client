...
void main() {
  ...
  group(PeritonealDialysisApi, () {
    ...
    //Future peritonealDialysisAutomaticDialysisDestroy(OffsetDate date) async
    test('test peritonealDialysisAutomaticDialysisDestroy', () async {
      // TODO
    });

    //Future<AutomaticPeritonealDialysis> peritonealDialysisAutomaticDialysisPartialUpdate(OffsetDate date, AutomaticPeritonealDialysisRequest automaticPeritonealDialysisRequest) async
    test('test peritonealDialysisAutomaticDialysisPartialUpdate', () async {
      // TODO
    });

    //Future<AutomaticPeritonealDialysis> peritonealDialysisAutomaticDialysisUpdate(OffsetDate date, AutomaticPeritonealDialysisRequest automaticPeritonealDialysisRequest) async
