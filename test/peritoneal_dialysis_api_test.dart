...
void main() {
  ...
  group(PeritonealDialysisApi, () {
    ...
    //Future peritonealDialysisAutomaticDialysisDestroy(String date) async
    test('test peritonealDialysisAutomaticDialysisDestroy', () async {
      // TODO
    });

    //Future<AutomaticPeritonealDialysis> peritonealDialysisAutomaticDialysisPartialUpdate(String date, AutomaticPeritonealDialysisRequest automaticPeritonealDialysisRequest) async
    test('test peritonealDialysisAutomaticDialysisPartialUpdate', () async {
      // TODO
    });

    //Future<AutomaticPeritonealDialysis> peritonealDialysisAutomaticDialysisUpdate(String date, AutomaticPeritonealDialysisRequest automaticPeritonealDialysisRequest) async
