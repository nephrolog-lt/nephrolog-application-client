...
void main() {
  ...
  group(PeritonealDialysisApi, () {
    ...
    //Future peritonealDialysisAutomaticDialysisDestroy(DateTime date) async
    test('test peritonealDialysisAutomaticDialysisDestroy', () async {
      // TODO
    });

    //Future<AutomaticPeritonealDialysis> peritonealDialysisAutomaticDialysisPartialUpdate(DateTime date, AutomaticPeritonealDialysisRequest automaticPeritonealDialysisRequest) async
    test('test peritonealDialysisAutomaticDialysisPartialUpdate', () async {
      // TODO
    });

    //Future<AutomaticPeritonealDialysis> peritonealDialysisAutomaticDialysisUpdate(DateTime date, AutomaticPeritonealDialysisRequest automaticPeritonealDialysisRequest) async
    test('test peritonealDialysisAutomaticDialysisUpdate', () async {
      // TODO
    });

    //Future<AutomaticPeritonealDialysisPeriodResponse> peritonealDialysisAutomaticPeriodRetrieve(DateTime from, DateTime to) async
