...
void main() {
  ...
  group(NutritionApi, () {
    //Future<DailyIntakesReportsResponse> nutritionDailyReportsLightRetrieve({ OffsetDate from, OffsetDate to }) async
    test('test nutritionDailyReportsLightRetrieve', () async {
      // TODO
    });

    //Future<DailyIntakesReportResponse> nutritionDailyReportsRetrieve(OffsetDate date) async
    ...
    //Future<NutrientWeeklyScreenResponse> nutritionWeeklyRetrieve(OffsetDate from, OffsetDate to) async
