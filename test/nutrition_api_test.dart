...
void main() {
  ...
  group(NutritionApi, () {
    //Future<DailyIntakesReportsResponse> nutritionDailyIntakesReportsLightRetrieve() async
    test('test nutritionDailyIntakesReportsLightRetrieve', () async {
      // TODO
    });

    //Future<DailyIntakesReportResponse> nutritionDailyIntakesReportsRetrieve(String date) async
    test('test nutritionDailyIntakesReportsRetrieve', () async {
      // TODO
    });
