...
void main() {
  ...
  group(HealthStatusApi, () {
    ...
    //Future<DailyHealthStatus> healthStatusRetrieve(OffsetDate date) async
    ...
    //Future<HealthStatusWeeklyScreenResponse> healthStatusWeeklyRetrieve(OffsetDate from, OffsetDate to) async
